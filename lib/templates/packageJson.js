module.exports=`{
    ...
    "scripts": {
      ...
      "db:migrate": "node_modules/.bin/sequelize db:migrate --config src/config/db-config.js --url mysql://nodester:nodester@database_{{serviceName}}/{{serviceName}}db",
      "db:migrate:prod": "node_modules/.bin/cross-env NODE_ENV=production node_modules/.bin/sequelize db:migrate --config src/config/db-config.js --url mysql://root:@database_{{serviceName}}/{{serviceName}}db",
